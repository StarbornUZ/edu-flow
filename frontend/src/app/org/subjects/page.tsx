...
import { Plus, BookMarked, Globe, Building2 } from "lucide-react";
          ...
          {orgSubjects.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                {orgSubjects.map((s) => (
                  <div key={s.id} className="flex items-center gap-3 rounded-lg border bg-background p-3">
                    ...
                    <Badge variant="outline" className="ml-auto shrink-0 text-xs">Tashkilot</Badge>
                  </div>
                ))}
              </div>
            </div>
